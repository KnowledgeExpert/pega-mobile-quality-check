...
import { WaitFrameToLoadOptions } from './wait-frame-to-load-options';
...
interface ControllerUtilActions {
    ...
    waitForFrameToLoad(selector: selectorType, options?: WaitFrameToLoadOptions): ControllerPromise;
