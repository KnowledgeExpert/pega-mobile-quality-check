...
import { WaitFrameToLoadOptions } from '../../types/test-api/controller/wait-frame-to-load-options';
...
export declare class ControllerProxy {
    ...
    waitForFrameToLoad(selector: any, options: WaitFrameToLoadOptions): Promise<void>;
